...
def set_from_collection(slot_coll, variant_name): # hide all in coll and show given variant based on name
   ...
   #    else:
   #       meshes = bpy.data.collections.get(variant_coll).objects # if character texture variant doesnt exist
   #       # mesh set armature?
...
def update_DNA_with_strand(new_dnastrand, coll_name):
   ...
   if last_item != 'Null':
      print(CharacterItems[coll_name])
      ...
      last_ckey = "001" # TODO FIND A COLOUR KEY
